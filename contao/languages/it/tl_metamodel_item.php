...
$GLOBALS['TL_LANG']['tl_metamodel_item']['createvariant']['0'] = 'Nuova variante';
$GLOBALS['TL_LANG']['tl_metamodel_item']['createvariant']['1'] = 'Crea una nuova variante dell\'elemento ID %s';
$GLOBALS['TL_LANG']['tl_metamodel_item']['cut']['0']           = 'Sposta elemento';
$GLOBALS['TL_LANG']['tl_metamodel_item']['cut']['1']           = 'Sposta elemento ID %s';
$GLOBALS['TL_LANG']['tl_metamodel_item']['delete']['0']        = 'Cancella elemento';
$GLOBALS['TL_LANG']['tl_metamodel_item']['delete']['1']        = 'Cancella elemento ID %s';
$GLOBALS['TL_LANG']['tl_metamodel_item']['edit']['0']          = 'Modifica elemento';
$GLOBALS['TL_LANG']['tl_metamodel_item']['edit']['1']          = 'Modifica elemento ID %s';
$GLOBALS['TL_LANG']['tl_metamodel_item']['editheader']['0']    = 'Modifica il tipo di elemento';
$GLOBALS['TL_LANG']['tl_metamodel_item']['editheader']['1']    = 'Modifica il tipo di elemento';
$GLOBALS['TL_LANG']['tl_metamodel_item']['fields']['0']        = 'Gestisce gli attributi';
