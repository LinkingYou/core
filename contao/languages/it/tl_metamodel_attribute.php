...
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['colname']['0']     = 'Nome del campo';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['colname']['1']     = 'Nome del campo della tabella';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['copy']['0']        = 'Copia la definizione dell\'attributo';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['copy']['1']        = 'Copia la definizione dell\'attributo ID %s';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['cut']['0']         = 'Taglia la definizione dell\'attributo';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['cut']['1']         = 'Taglia la definizione dell\'attributo ID %s';
...
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['editheader']['1']  = 'Modifica l\'attributo';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['isunique']['0']    = 'Valori univoci';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['isunique']['1']    = 'Selezionare questa opzione se si desidera che ogni valore sia inserito una sola volta.';
...
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['new']['1']         = 'Crea un nuovo attributo';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['pasteafter']['0']  = 'Crea un nuovo attributo';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['show']['0']        = 'Dettagli dell\'attributo';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['show']['1']        = 'Mostra i dettagli dell\'attributo ID %s';
