...
$GLOBALS['TL_LANG']['tl_metamodel_dca']['becap_description']['1']      = 'Le texte spécifié sera utilisé comme description (survol) dans le menu du back-office.';
$GLOBALS['TL_LANG']['tl_metamodel_dca']['becap_label']['0']            = 'Texte d\'étiquette';
$GLOBALS['TL_LANG']['tl_metamodel_dca']['becap_label']['1']            = 'Le texte spécifié sera utilisé comme étiquette de menu dans le menu du back-office.';
$GLOBALS['TL_LANG']['tl_metamodel_dca']['becap_langcode']['0']         = 'Langue';
$GLOBALS['TL_LANG']['tl_metamodel_dca']['becap_langcode']['1']         = 'Sélectionez le language que vous souhaitez fournir.';
$GLOBALS['TL_LANG']['tl_metamodel_dca']['copy']['0']                   = 'Copier définition du masque de saisie';
$GLOBALS['TL_LANG']['tl_metamodel_dca']['copy']['1']                   = 'Copier définition du masque de saisie ID %s';
$GLOBALS['TL_LANG']['tl_metamodel_dca']['delete']['0']                 = 'Supprimer masque de saisie';
...
$GLOBALS['TL_LANG']['tl_metamodel_dca']['rendermodes']['hierarchical'] = 'Hiérarchique';
...
$GLOBALS['TL_LANG']['tl_metamodel_dca']['settings']['0']               = 'Paramètres masque de saisie';
$GLOBALS['TL_LANG']['tl_metamodel_dca']['settings']['1']               = 'Éditer paramètres masque de saisie ID %s';
$GLOBALS['TL_LANG']['tl_metamodel_dca']['show']['0']                   = 'Détail masque de saisie';
...
$GLOBALS['TL_LANG']['tl_metamodel_dca']['use_limitview']['0']          = 'Restriction de vue';
$GLOBALS['TL_LANG']['tl_metamodel_dca']['use_limitview']['1']          = 'Activer la restriction de vue.';
$GLOBALS['TL_LANG']['tl_metamodel_dca']['view_legend']                 = 'Paramètres de vue';
