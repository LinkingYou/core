...
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['additionalJs']['0']      = 'Fichiers javascript additionnels';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['additionalJs']['1']      = 'Choisir ceci si vous souhaitez inclure des fichier javascript additionnels.';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['copy']['0']              = 'Copier définition du paramètre';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['copy']['1']              = 'Copier paramètre ID %s';
...
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['expert_legend']          = 'Paramètres expert';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['file']                   = 'Fichier';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['format']['0']            = 'Format de sortie';
...
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['jumpTo_page']['1']       = 'La page à utiliser pour les liens de détails.';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['name']['0']              = 'Nom';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['name']['1']              = 'Nom paramètre';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['new']['0']               = 'Nouveau';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['new']['1']               = 'Créer nouveau paramètre';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['publish']                = 'Publier';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['settings']['0']          = 'Définir paramètres de l\'attribut';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['settings']['1']          = 'Définir paramètres de l\'attribut ID %s';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['show']['0']              = 'Filtrer détails';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['show']['1']              = 'Montrer détails du paramètre ID %s';
