...
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['error_unknown_attribute'] = 'Unbekanntes Attribut!';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['error_unknown_column']    = 'unbekannte Spalte';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['error_unknown_id']        = 'unbekannte ID: %s';
