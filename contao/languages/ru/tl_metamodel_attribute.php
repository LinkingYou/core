...
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['cut']['1']                     = 'Вырезать определение атрибута ID %s';
...
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['error_unknown_attribute']['0'] = 'Неизвестный атрибут!';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['error_unknown_attribute']['1'] = 'Расширение потеряно? Тип атрибута "%s" не установлен.';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['isunique']['0']                = 'Уникальные значения';
...
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['type']['0']                    = 'Тип атрибута';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['type']['1']                    = 'Выберите тип атрибута. ВНИМАНИЕ: Если вы измените тип, будут удалены все существующие данные этого атрибута.';
