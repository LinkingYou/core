...
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['attr_id']['1']                 = 'Атрибут этой настройки относится к.';
...
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['edit']['1']                    = 'Редактировать настройки ID %s.';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['filterable']['0']              = 'Фильтруемый';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['filterable']['1']              = 'Выберите, если этот атрибут должен быть доступен для фильтрации в панели управления.';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['flag']['0']                    = 'Переопределить флаг сортировки';
...
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['legendhide']['0']              = 'Скрыть легенду';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['legendhide']['1']              = 'Скрыть легенду по умолчанию.';
...
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortingflag']['10']            = 'Сортировать по убыванию лет';
...
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortingflag']['2']             = 'Сортировать по убыванию алфавита';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortingflag']['5']             = 'Сортировать по возрастанию дней';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortingflag']['6']             = 'Сортировать по убыванию дней';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortingflag']['7']             = 'Сортировать по возрастанию месяцев';
