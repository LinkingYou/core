...
$GLOBALS['TL_LANG']['tl_metamodel_filter']['copy']['1']       = 'Копировать настройки фильтра ID %s.';
$GLOBALS['TL_LANG']['tl_metamodel_filter']['delete']['0']     = 'Удалить настройки фильтра';
$GLOBALS['TL_LANG']['tl_metamodel_filter']['delete']['1']     = 'Удалить настройки фильтра ID %s';
$GLOBALS['TL_LANG']['tl_metamodel_filter']['edit']['0']       = 'Редактировать настройки';
...
$GLOBALS['TL_LANG']['tl_metamodel_filter']['pastenew']['0']   = 'Новый';
$GLOBALS['TL_LANG']['tl_metamodel_filter']['pastenew']['1']   = 'Создать новый параметр фильтра';
