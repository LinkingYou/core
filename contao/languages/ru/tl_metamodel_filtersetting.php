...
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['copy']['0']                 = 'Копировать определение настроек фильтра';
...
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['delete']['1']               = 'Удалить настройки фильтра ID %s';
