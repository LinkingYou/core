...
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['comment']['0']              = 'Kommentaar';
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['config_legend']             = 'Seadistamine';
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['defaultid']['0']            = 'Vaikeväärtus';
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['defaultid']['1']            = 'Vaikeväärtus valikule.';
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['delete']['0']               = 'Kustuta filtri seaded';
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['edit']['0']                 = 'Muuda seadet';
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['enabled']['0']              = 'Sisse lülitatud';
...
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['typenames']['customsql']    = 'Kohandatud SQL';
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['typenames']['simplelookup'] = 'Lihtne otsing';
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['urlparam']['0']             = 'Lingi parameeter';
