...
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['edit']['0']               = 'Muuda seadet';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['error_unknown_attribute'] = 'tundmatu omadus';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['error_unknown_column']    = 'tundmatu veerg';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['error_unknown_id']        = 'tundmatu ID: %s';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['expert_legend']           = 'Seaded eksportidele';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['file']                    = 'Fail';
...
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['jumpTo_language']['0']    = 'Keel';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['jumpTo_page']['0']        = 'Hüppa lehele';
