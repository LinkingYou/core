...
$GLOBALS['TL_LANG']['tl_metamodel_item']['createvariant']['0'] = 'Νέα παραλλαγή ';
$GLOBALS['TL_LANG']['tl_metamodel_item']['createvariant']['1'] = 'Δημιουργια μια νέα παραλλαγή του στοιχείου ID %s ';
$GLOBALS['TL_LANG']['tl_metamodel_item']['cut']['0']           = 'Μετακινηση στοιχειου';
$GLOBALS['TL_LANG']['tl_metamodel_item']['cut']['1']           = 'Μετακινηση στοιχειου ID %s';
$GLOBALS['TL_LANG']['tl_metamodel_item']['delete']['0']        = 'Διαγραφη στοιχειου';
$GLOBALS['TL_LANG']['tl_metamodel_item']['delete']['1']        = 'Διαγραφη στοιχειου ID %s';
$GLOBALS['TL_LANG']['tl_metamodel_item']['edit']['0']          = 'Επεξεργασια στοιχειου';
