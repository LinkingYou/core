...
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['chosen']['0']                  = 'Επιλογη';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['chosen']['1']                  = 'Ενεργοποίηση επιλογης γραφικων widget.';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['cols']['0']                    = 'Στήλη ';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['cols']['1']                    = 'Ποσό των στηλών που θα χρησιμοποιηθεί για LONGTEXT / πίνακα widget ';
...
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['dcatype']['1']                 = 'Επιλεξτε τον τυπο χαρακτηριστικόυ.';
...
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['filterable']['0']              = 'Φιλτραρίσμα';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['filterable']['1']              = 'Ελέγξτε αν αυτό το χαρακτηριστικό είναι υποχρεωτικο.';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['flag']['0']                    = 'Ταξινόμηση παράκαμψης σημαίας ';
...
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['rte']['1']                     = 'Επιλέξτε την πλούσια διαμόρφωση κειμένου που πρέπει να χρησιμοποιείται σε αυτόν τον τομέα (εάν υπάρχει). ';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['searchable']['0']              = 'Αναζητησιμο';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['searchable']['1']              = 'Ελέγξτε αν αυτό το χαρακτηριστικό είναι υποχρεωτικο.';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['show']['0']                    = 'Λεπτομερειες ρυθμισης ';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['show']['1']                    = 'Δείτε λεπτομέρειες σχετικά με τη ρύθμιση ID%s';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortable']['0']                = 'Ανακαταταξη';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortable']['1']                = 'Ελέγξτε αν αυτό το χαρακτηριστικό είναι υποχρεωτικο.';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortingflag']['1']             = 'Ταξινόμηση με αρχικό γράμμα αύξουσα ';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortingflag']['10']            = 'Ταξινόμηση κατά φθίνουσα έτος ';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortingflag']['11']            = 'Αύξουσα ταξινόμηση ';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortingflag']['12']            = ' Φθίνουσα Ταξινόμηση ';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortingflag']['2']             = 'Ταξινόμηση με αρχικό γράμμα φθίνουσα ';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortingflag']['3']             = 'Ταξινόμηση με αρχικά γράμματα "μήκος" αύξουσα ';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortingflag']['4']             = 'Ταξινόμηση με αρχικά γράμματα "μήκος" φθίνουσα';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortingflag']['5']             = 'Ανά ημέρα αύξουσα ';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortingflag']['6']             = 'Ανά ημέρα φθίνουσα ';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortingflag']['7']             = 'Ανά μήνα αύξουσα';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortingflag']['8']             = 'Ανά μήνα φθίνουσα';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['sortingflag']['9']             = 'Ανά έτος αύξουσα';
$GLOBALS['TL_LANG']['tl_metamodel_dcasetting']['spaceToUnderscore']['0']       = 'Αντικατασταση χώρων με υπογράμμιση';
